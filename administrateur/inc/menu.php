                    ...
                    <div class="collapse" id="userCollapse">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <a href="#" id="creerUser" class="pageLink">Créer un utilisateur</a></li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="userCon" class="pageLink">Utilisateurs Connectés</a>
                            </li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="userList" class="pageLink">Liste des utilisateurs</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item accordion">
                    ...
                    <div class="collapse" id="uniteCollapse">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="uoList" class="pageLink">Liste des Unités Organisationnelles </a></li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="distrib" class="pageLink">Distributeurs en instance</a>
                            </li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="sousDistrib" class="pageLink">Sous distributeur en instance</a>
                            </li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="gHoraire" class="pageLink">Gérer horaire</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item accordion">
                    ...
                    <div class="collapse" id="jourCollapse">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="rapJour" class="pageLink">Rapport de fin de journée</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item accordion">
                    ...
                    <div class="collapse" id="extractionCollapse">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="extJour" class="pageLink">Journaux</a></li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="extBord" class="pageLink">Bordereaux</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item accordion">
                    ...
                    <div class="collapse" id="reportingCollapse">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="repJour" class="pageLink">Journaux</a></li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="repBord" class="pageLink">Bordereaux</a>
                            </li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right" class="pageLink"></i>
                                <a href="#" id="sitGuichet" class="pageLink">Situation de Guichet</a>
                            </li>
                            <li class="list-group-item">
                                <i class="fa fa-caret-right"></i>
                                <a href="#" id="relDistrib" class="pageLink">Relevé de Distributeur</a>
                            </li>
                        </ul>
                    </div>
                </li>
